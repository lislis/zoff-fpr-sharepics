...
import { templates, templatesFO } from "../config/vars";

export default () => {
  return (
    <Layout>
      <div className="block bg-darkGray font-lulo leading-normal">
        ...
        <div className="container py-2">
          <div className="mx-auto grid grid-cols-12 gap-y-3 gap-x-4 py-5">
            <div className="col-span-12 text-center">
              <h2 className="text-lg text-white font-lulo font-bold uppercase leading-tight">
                FrauenOrte • sharepics
              </h2>
            </div>
            {templatesFO.map((template) => (
              <div className="col-span-12 sm:col-span-4 text-center">
                <Link to={template.link} className="no-underline">
                  <span
                    className="block text-base text-white uppercase pb-2"
